...
import { Radio, Mail, Lock, Eye, EyeOff, User, Phone, Gift } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-1">Start streaming in minutes</p>
        </div>

        <div className="glass rounded-2xl p-6">
          <button className="w-full flex items-center justify-center gap-3 bg-white text-gray-900 py-3 rounded-lg font-medium hover:bg-gray-100 transition mb-4">
          ...
          <form className="space-y-4">
            ...
            <div>
              <label className="text-sm font-medium text-gray-300 mb-1 block">Phone Number</label>
              <div className="relative">
            ...
            <div>
              <label className="text-sm font-medium text-gray-300 mb-1 block">Referral Code (Optional)</label>
              <div className="relative">
